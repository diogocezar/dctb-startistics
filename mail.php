<?php
	...
	$yesterday_plot = date("d/m/Y", strtotime("-1 day"));
	$fields = array(
		'facebook',
		'twitter',
		'instagram',
	...
	$html .= "<h1>Lorem StArtistics - Relatório Diário</h1>". "\n";
	$html .= "<h2>Crescimento entre ".$yesterday_plot. " e ".$today_plot ."</h2>". "\n";

	foreach($fields as $field){
		$sql_sum = "SELECT (max(".$field.")-min(".$field.")) as diff FROM startistics WHERE date BETWEEN '$yesterday' AND '$today' GROUP BY artist";
